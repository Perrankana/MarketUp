...
data class ProductStep(override val totalSold: Float, val products: List<Product>, val filteredProducts: List<Product>, val quickSearch: List<String>, val selectedFormat: String, val selectedCat: String): TPVSceneData(totalSold)
